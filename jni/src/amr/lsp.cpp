...

{
    ...
    if (req_mode == MR122)
    {
        Az_lsp_amr(&az[MP1], lsp_mid, st->lsp_old, pOverflow);
        Az_lsp_amr(&az[MP1 * 3], lsp_new, lsp_mid, pOverflow);
    ...
    {
        Az_lsp_amr(&az[MP1 * 3], lsp_new, st->lsp_old, pOverflow);  /* From A(z) to lsp  */
