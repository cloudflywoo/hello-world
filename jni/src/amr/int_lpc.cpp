...
)
{
    ...
    Lsp_Az_Amr(lsp, Az, pOverflow);            /* Subframe 1 */
    Az += MP1 * 2;
    ...
    Lsp_Az_Amr(lsp, Az, pOverflow);            /* Subframe 3 */
...
)
{
    ...
    Lsp_Az_Amr(lsp, Az, pOverflow);        /* Subframe 2 */
    ...
    Lsp_Az_Amr(lsp_new, Az, pOverflow);    /* Subframe 4 */
