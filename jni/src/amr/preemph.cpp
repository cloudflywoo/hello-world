...
/*
------------------------------------------------------------------------------
 FUNCTION NAME:  preemphasis_amr
------------------------------------------------------------------------------
 INPUT AND OUTPUT DEFINITIONS

 Inputs:
    st -- Pointer to preemphasisState -- preemphasis_amr filter state
    signal -- array of type Word16 -- input signal overwritten by the output
    g -- Word16 -- preemphasis_amr coefficient
...
void preemphasis_amr(
    preemphasisState *st, /* (i/o) : preemphasis_amr filter state               */
    Word16 *signal,       /* (i/o) : input signal overwritten by the output */
    Word16 g,             /* (i)   : preemphasis_amr coefficient                */
