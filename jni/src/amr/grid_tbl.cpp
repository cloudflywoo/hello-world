...
------------------------------------------------------------------------------
 ...
 //
 // grid_amr[0] = 1.0;
 // grid_amr[grid_points+1] = -1.0;
 // for (i = 1; i < grid_points; i++)
 //   grid_amr[i] = cos((6.283185307*i)/(2.0*grid_points));
 //
 //
...
#define grid_points 60
    ...
    ----------------------------------------------------------------------------*/
    const Word16 grid_amr[grid_points + 1] =
    {
...
------------------------------------------------------------------------------
 ...
 [1] grid_amr.tab,  UMTS GSM AMR speech codec, R99 - Version 3.2.0, March 2, 2001
