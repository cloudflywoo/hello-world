...
------------------------------------------------------------------------------
 ...
 This file contains the function the implements the Levinson_Amr-Durbin algorithm
 using double-precision arithmetic. This file also includes functions to
 initialize, allocate, and deallocate memory used by the Levinson_Amr function.
...
------------------------------------------------------------------------------
 ...
 Outputs:
    pointer pointed to by state points to the newly allocated memory to
      be used by Levinson_Amr function
...
------------------------------------------------------------------------------
 ...
 This function initializes the state memory used by the Levinson_Amr function to
 zero.
...
------------------------------------------------------------------------------
 ...
 This function deallocates the state memory used by the Levinson_Amr function.
...
------------------------------------------------------------------------------
 ...
 This function implements the Levinson_Amr-Durbin algorithm using double-
