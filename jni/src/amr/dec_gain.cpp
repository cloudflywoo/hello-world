...
------------------------------------------------------------------------------
 ...
 agc_amr.c, UMTS GSM AMR speech codec, R99 - Version 3.2.0, March 2, 2001
...
)
{
    ...
    /* Read the quantized gains (table_amr depends on mode) */
    ...
    else
    {
        if (mode == MR475)
        {
            ...
            *gain_pit = *p++;
             ...
             *  quantizer table_amr to save space):                        *
             *  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  *
             *                                                         *
             *   qua_ener       = log2(g)                              *
    ...
    /*------------------------------------------------------------------*
     *  read quantized gains, update table_amr of past quantized energies   *
     *  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   *
    ...
    *gain_cod = (Word16)(L_tmp >> 16);
    ...
    /* update table_amr of past quantized energies */
