...
------------------------------------------------------------------------------
 ...
 The function Pow2(L_x) is approximated by a table_amr and linear interpolation.

 1- i = bit10-b15 of fraction,   0 <= i <= 31
 2- a = bit0-b9   of fraction
 3- L_x = table_amr[i]<<16 - (table_amr[i] - table_amr[i+1]) * a * 2
...
)
{
    ...
    L_x = L_deposit_h (table_amr[i]);       // table_amr[i] << 16
