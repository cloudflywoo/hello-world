...
------------------------------------------------------------------------------
 ...
 Global Variables Used:
    WmfEncBytesPerFrame = table_amr containing the number of encoder frame
                          data bytes per codec mode for WMF output
                          format (const int)
    If2EncBytesPerFrame = table_amr containing the number of encoder frame
...
------------------------------------------------------------------------------
 ...
 WMF bytes encoded is obtained from WmfEncBytesPerFrame table_amr and returned via
 num_enc_bytes.
 ...
 IF2 bytes encoded is obtained from If2EncBytesPerFrame table_amr and returned via
 num_enc_bytes.
