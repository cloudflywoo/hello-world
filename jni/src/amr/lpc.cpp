...
------------------------------------------------------------------------------
 PSEUDO-CODE
   ...
   {
       // Autocorrelations
       Autocorr_Amr(x_12k2, M, rHigh, rLow, window_160_80);
       // Lag windowing
       Lag_window_amr(M, rHigh, rLow);
       // Levinson_Amr Durbin
       Levinson_Amr(st->levinsonSt, rHigh, rLow, &a[MP1], rc);

       // Autocorrelations
       Autocorr_Amr(x_12k2, M, rHigh, rLow, window_232_8);
       // Lag windowing
       Lag_window_amr(M, rHigh, rLow);
       // Levinson_Amr Durbin
       Levinson_Amr(st->levinsonSt, rHigh, rLow, &a[MP1 * 3], rc);
   }
   else
   {
       // Autocorrelations
       Autocorr_Amr(x, M, rHigh, rLow, window_200_40);
       // Lag windowing
       Lag_window_amr(M, rHigh, rLow);
       // Levinson_Amr Durbin
       Levinson_Amr(st->levinsonSt, rHigh, rLow, &a[MP1 * 3], rc);
...
void lpc(
    ...
    CommonAmrTbls* common_amr_tbls, /* i : ptr to struct with table_amr ptrs */
    Flag   *pOverflow
)
{
    Word16 rc[4];                  /* First 4 reflection coefficients Q15 */
    ...
    {
        /* Autocorrelations */
        Autocorr_Amr(x_12k2, M, rHigh, rLow, window_160_80_ptr, pOverflow);
        /* Lag windowing    */
        Lag_window_amr(M, rHigh, rLow, pOverflow);
        /* Levinson_Amr Durbin  */
        Levinson_Amr(st->levinsonSt, rHigh, rLow, &a[MP1], rc, pOverflow);

        /* Autocorrelations */
        Autocorr_Amr(x_12k2, M, rHigh, rLow, window_232_8_ptr, pOverflow);
        /* Lag windowing    */
        Lag_window_amr(M, rHigh, rLow, pOverflow);
        /* Levinson_Amr Durbin  */
        Levinson_Amr(st->levinsonSt, rHigh, rLow, &a[MP1 * 3], rc, pOverflow);
    }
    else
    {
        /* Autocorrelations */
        Autocorr_Amr(x, M, rHigh, rLow, window_200_40_ptr, pOverflow);
        /* Lag windowing    */
        Lag_window_amr(M, rHigh, rLow, pOverflow);
        /* Levinson_Amr Durbin  */
        Levinson_Amr(st->levinsonSt, rHigh, rLow, &a[MP1 * 3], rc, pOverflow);
