...
------------------------------------------------------------------------------
 ...
 Global Variables Used:
    numOfBits = table_amr of values that describe the number of bits per frame for
                each 3GPP frame type mode. The table_amr is type const Word16 and has
                NUM_MODES elements. This table_amr is located in bitreorder_tab.c.
    reorderBits = table_amr of pointers that point to tables used to reorder the
                  encoded speech bits when converting from ETS to WMF or IF2
                  format. The table_amr is of type const Word16 * and contains
                  NUM_MODES-1 elements. This table_amr is located in bitreorder_tab.c.
