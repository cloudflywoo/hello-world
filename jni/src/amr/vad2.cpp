...
/*
 * The channel table_amr is defined below.  In this table_amr, the
 * lower and higher frequency coefficients for each of the 16
 * channels are specified.  The table_amr excludes the coefficients
...
/* channel energy scaling table_amr - allows efficient division by number
...
/*
 * The voice metric table_amr is defined below.  It is a non-
 * linear table_amr with a deadband near zero.  It maps the SNR
...
Word16 vad2(Word16 * farray_ptr, vadState2 * st, Flag *pOverflow)
{
    ...
    /* Energy scale table_amr given 30,1 input scaling (also account for -6 dB shift on input) */
