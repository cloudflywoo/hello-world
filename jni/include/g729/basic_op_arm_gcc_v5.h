...
extern "C"
{
    ...
    */
    ...
    ____inline Word32 L_add(register Word32 L_var1, register Word32 L_var2, Flag *pOverflow)
    {
    ...
    */
    ____inline Word32 L_sub(Word32 L_var1, Word32 L_var2, Flag *pOverflow)
{
        register Word32 ra = L_var1;
        register Word32 rb = L_var2;
        Word32 result;
    ...
    static __inline Word32 L_mac(Word32 L_var3, Word16 var1, Word16 var2, Flag *pOverflow)
{
    ...
    */
    ...
    ____inline Word32 L_mult(Word16 var1, Word16 var2, Flag *pOverflow)
{
    ...
    */
    ____inline Word32 L_msu(Word32 L_var3, Word16 var1, Word16 var2, Flag *pOverflow)
{
        register Word32 ra = L_var3;
        register Word32 rb = var1;
        register Word32 rc = var2;
                                   ...
                                   Flag *pOverflow)
{
    ...
    */
    ____inline Word16 mult(Word16 var1, Word16 var2, Flag *pOverflow)
{
        register Word32 ra = var1;
        register Word32 rb = var2;
        Word32 product;
    ...
    ____inline Word32 amrnb_fxp_mac_16_by_16bb(Word32 L_var1, Word32 L_var2, Word32 L_var3)
{
        register Word32 ra = L_var1;
        register Word32 rb = L_var2;
    ...
    ____inline Word32 amrnb_fxp_msu_16_by_16bb(Word32 L_var1, Word32 L_var2, Word32 L_var3)
{
        register Word32 ra = L_var1;
        register Word32 rb = L_var2;
        register Word32 rc = L_var3;
