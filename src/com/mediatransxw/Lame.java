...
public class Lame {
    ...
    public static native int DestroyInstance(int instanceId);
     ...
     */
    public static native int initializeEncoder(int instanceId, int sampleRate, int numChannels);
     ...
     */
    public static native int setEncoderPreset(int instanceId, int preset);
     ...
     */
    public static native int encode(int instanceId, short[] leftChannel,
            short[] rightChannel, int channelSamples, byte[] mp3Buffer,
            int bufferSize);

    public static native int encode2(int instanceId, byte[] leftChannel,
                                     byte[] rightChannel, int channelSamples, byte[] mp3Buffer,
                                    int bufferSize);
     ...
     */
    public static native int flushEncoder(int instanceId, byte[] mp3Buffer, int bufferSize);
     ...
     */
    public static native int closeEncoder(int instanceId);
     ...
     * @return -1 if error occured, otherwise 0
     */
    public static native int initializeDecoder(int instanceId);
     ...
     * @return sample rate
     */
    public static native int getDecoderSampleRate(int instanceId);
     ...
     */
    public static native int getDecoderChannels(int instanceId);
     ...
     */
    public static native int getDecoderDelay(int instanceId);
     ...
     */
    public static native int getDecoderPadding(int instanceId);
     ...
     */
    public static native int getDecoderTotalFrames(int instanceId);
     ...
     */
    public static native int getDecoderFrameSize(int instanceId);
     ...
     * @return bitrate
     */
    public static native int getDecoderBitrate(int instanceId);
     ...
     */
    public static int configureDecoder(int instanceId, InputStream input) throws IOException {
        int size = 100;
        ...
        do {
            size = input.read(buf);
            if (nativeConfigureDecoder(instanceId, buf, size) == 0) {
                return 0;
            }
        } while(size > 0);
        return -1;
    ...
    private static native int nativeConfigureDecoder(int instanceId, byte[] inputBuffer, int bufferSize);
     ...
     */
    public static int decodeFrame(int instanceId, InputStream input,
        ...
        samplesRead = nativeDecodeFrame(instanceId, buf, len, pcmLeft, pcmRight);
        if (samplesRead != 0) {
            return samplesRead;
        }
        while (true) {
    ...
    public static native int nativeDecodeFrame(int instanceId, byte[] inputBuffer, int bufferSize,
     ...
     * @return -1 if error occurred, 0 on success
     */
    public static native int closeDecoder(int instanceId);
}